...
/** Desktop navigation (lg and up), resizable. Phones and tablets use the
 * bottom bar in mobile-nav.tsx instead. */
export function Sidebar() {
  ...
  return (
    <aside
      ref={asideRef}
      style={{ width }}
      className="relative hidden h-dvh shrink-0 flex-col border-r border-border bg-surface lg:flex"
    >
