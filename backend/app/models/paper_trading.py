...
class PaperNativeDeployment(Base):
    ...
    # Where the owner placed this card on the Paper Trading page (0 = top).
    # None until they first reorder -- those sort above placed ones, newest
    # first, so a new deployment still shows up at the top.
