...
shared list, since the two sources genuinely support different sets
...
"45m" isn't offered anywhere -- neither source has a real 45-minute
native resolution, and fabricating one via resampling from a non-divisor
base (e.g. 15m -> 45m needs 3 bars to align, which drifts across session
boundaries) isn't something this exposes as if it were a clean native
interval.
